...
export default function Osintemailalldetails() {
  const { GetFactAppInfoMoreByEmailData } = useSelector(TBSelector);
  ...
  React.useEffect(() => {
    ...
    setData((e) => {
      return {
        ...e,
        criteria: GetFactAppInfoMoreByEmailData?.criteria,
        person: GetFactAppInfoMoreByEmailData?.data?.[0].length
          ? GetFactAppInfoMoreByEmailData?.data?.[0]?.luna?.person
          : GetFactAppInfoMoreByEmailData?.data?.[1]?.luna?.person,
        sources: GetFactAppInfoMoreByEmailData?.data?.[0]?.luna?.sources,
        status: GetFactAppInfoMoreByEmailData?.status,
        message: GetFactAppInfoMoreByEmailData?.message,
      };
    });
