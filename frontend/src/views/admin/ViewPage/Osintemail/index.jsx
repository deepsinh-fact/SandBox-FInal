...
export default function Osintemail() {
  const { GetFactAppInfoByEmailData } = useSelector(TBSelector);
  ...
  React.useEffect(() => {
    ...
    setData((e) => {
      return {
        ...e,
        criteria: GetFactAppInfoByEmailData?.criteria,
        datas: GetFactAppInfoByEmailData?.data,
        sources: GetFactAppInfoByEmailData?.sources,
        status: GetFactAppInfoByEmailData?.status,
        message: GetFactAppInfoByEmailData?.message,
      };
    });
